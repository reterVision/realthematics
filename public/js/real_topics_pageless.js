...
(function($) {
  ...
  $.pageless_brandon = function(opts) {
    $.isFunction(opts) ? settings.call() : init(opts);
  };
  
  var loaderHtml = function () {
    return settings.loaderHtml || '\
<div id="pageless-loader-brandon" class="span12" style="display:none;text-align:center;width:100%;">\
  <div class="msg" style="color:#e9e9e9;font-size:2em"></div>\
  <img src="' + settings.loaderImage + '" alt="loading more resources" style="margin:10px auto" />\
</div>';
  };
  ...
  $.fn.pageless_brandon = function (opts) {
    var $el = $(this)
